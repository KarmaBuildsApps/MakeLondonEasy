...
public class Earlier implements Parcelable
{
    ...
    @Expose
    private String uri;
    public final static Parcelable.Creator<Earlier> CREATOR = new Creator<Earlier>() {


        public Earlier createFromParcel(Parcel in) {
            Earlier instance = new Earlier();
        ...
        public Earlier[] newArray(int size) {
            return (new Earlier[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Earlier) == false) {
            return false;
        }
        Earlier rhs = ((Earlier) other);
