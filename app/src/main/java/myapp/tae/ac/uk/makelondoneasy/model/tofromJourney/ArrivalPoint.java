...
public class ArrivalPoint implements Parcelable {
    ...
    @Expose
    private Double lon;
    public final static Parcelable.Creator<ArrivalPoint> CREATOR = new Creator<ArrivalPoint>() {


        public ArrivalPoint createFromParcel(Parcel in) {
            ArrivalPoint instance = new ArrivalPoint();
        ...
        public ArrivalPoint[] newArray(int size) {
            return (new ArrivalPoint[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArrivalPoint) == false) {
            return false;
        }
        ArrivalPoint rhs = ((ArrivalPoint) other);
