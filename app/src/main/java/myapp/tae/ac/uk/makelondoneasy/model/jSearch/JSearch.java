...
public class JSearch implements Parcelable {
    ...
    public final static Parcelable.Creator<JSearch> CREATOR = new Creator<JSearch>() {


        public JSearch createFromParcel(Parcel in) {
            JSearch instance = new JSearch();
        ...
        public JSearch[] newArray(int size) {
            return (new JSearch[size]);
        }
    ...
    /**
     * @return The toLocationDisambiguation
     */
    ...
    /**
     * @param toLocationDisambiguation The toLocationDisambiguation
     */
    ...
    /**
     * @return The fromLocationDisambiguation
     */
    ...
    /**
     * @param fromLocationDisambiguation The fromLocationDisambiguation
     */
    ...
    /**
     * @return The viaLocationDisambiguation
     */
    ...
    /**
     * @param viaLocationDisambiguation The viaLocationDisambiguation
     */
    ...
    /**
     * @return The recommendedMaxAgeMinutes
     */
    ...
    /**
     * @param recommendedMaxAgeMinutes The recommendedMaxAgeMinutes
     */
    ...
    /**
     * @param journeyVector The journeyVector
     */
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof JSearch) == false) {
            return false;
        }
        JSearch rhs = ((JSearch) other);
