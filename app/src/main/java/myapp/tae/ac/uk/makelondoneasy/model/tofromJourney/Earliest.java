...
public class Earliest implements Parcelable
{
    ...
    @Expose
    private String uri;
    public final static Parcelable.Creator<Earliest> CREATOR = new Creator<Earliest>() {


        public Earliest createFromParcel(Parcel in) {
            Earliest instance = new Earliest();
        ...
        public Earliest[] newArray(int size) {
            return (new Earliest[size]);
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Earliest) == false) {
            return false;
        }
        Earliest rhs = ((Earliest) other);
